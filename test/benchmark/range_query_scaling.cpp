...
int main(int argc, char **argv) {
  ...
  std::vector<coord_t> radii = {static_cast<coord_t>(0.01), static_cast<coord_t>(0.1),   static_cast<coord_t>(1.0),
                                static_cast<coord_t>(10.0), static_cast<coord_t>(100.0), static_cast<coord_t>(200.0)};
