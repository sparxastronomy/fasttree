...
void print_benchmark_row(const std::string& test_name, const std::string& hardware, size_t count, const std::string& params, double time_sec, size_t memory_kb, const std::string& notes = "-") {
